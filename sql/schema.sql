...
-- config_json mirrors public_html/data/stages/*.json (procedural renderer
-- key, camouflage zones, spawn points, movement bounds) minus the fields
-- that already have their own columns (slug/name/width/height/background
-- image) — see api/get-config.php, which merges those columns back in
-- before handing the config to the frontend. Keep these two in sync if you
-- edit the seed stages by hand instead of through the admin panel's editor.
INSERT INTO stages (slug, name, background_image, width, height, config_json, sort_order) VALUES
('warehouse', 'Warehouse', NULL, 960, 540, '{"procedural":"warehouse","bounds":{"x":30,"y":260,"w":900,"h":250},"zones":[{"x":60,"y":300,"w":120,"h":90,"label":"Wooden Crate"},{"x":220,"y":330,"w":160,"h":60,"label":"Cardboard Boxes"},{"x":430,"y":290,"w":90,"h":140,"label":"Steel Pipe Rack"},{"x":580,"y":320,"w":140,"h":70,"label":"Oil Drum Row"},{"x":770,"y":300,"w":110,"h":100,"label":"Loading Pallet"}],"hiderSpawns":[[80,470],[260,470],[440,470],[620,470],[800,470]],"seekerSpawns":[[480,480]]}', 1),
('classroom', 'Classroom', NULL, 960, 540, '{"procedural":"classroom","bounds":{"x":30,"y":260,"w":900,"h":250},"zones":[{"x":70,"y":300,"w":100,"h":130,"label":"Bookshelf"},{"x":230,"y":340,"w":150,"h":70,"label":"Student Desk Row"},{"x":430,"y":280,"w":100,"h":60,"label":"Green Chalkboard"},{"x":590,"y":330,"w":130,"h":80,"label":"Storage Cabinet"},{"x":780,"y":310,"w":100,"h":100,"label":"Window Curtain"}],"hiderSpawns":[[100,470],[280,470],[460,470],[640,470],[820,470]],"seekerSpawns":[[480,480]]}', 2),
('office', 'Office', NULL, 960, 540, '{"procedural":"office","bounds":{"x":30,"y":260,"w":900,"h":250},"zones":[{"x":60,"y":320,"w":130,"h":70,"label":"Filing Cabinet"},{"x":240,"y":300,"w":110,"h":110,"label":"Server Rack"},{"x":420,"y":340,"w":150,"h":60,"label":"Meeting Table"},{"x":600,"y":290,"w":90,"h":120,"label":"Potted Plant Wall"},{"x":760,"y":310,"w":120,"h":90,"label":"Water Cooler Nook"}],"hiderSpawns":[[90,470],[270,470],[450,470],[630,470],[810,470]],"seekerSpawns":[[480,480]]}', 3),
('street', 'Street', NULL, 960, 540, '{"procedural":"street","bounds":{"x":30,"y":260,"w":900,"h":250},"zones":[{"x":60,"y":300,"w":100,"h":130,"label":"Brick Wall Mural"},{"x":230,"y":340,"w":120,"h":70,"label":"Trash Bin Row"},{"x":420,"y":290,"w":90,"h":130,"label":"Street Lamp Post"},{"x":580,"y":320,"w":140,"h":70,"label":"Bus Stop Bench"},{"x":770,"y":300,"w":110,"h":100,"label":"Newspaper Stand"}],"hiderSpawns":[[80,470],[260,470],[440,470],[620,470],[800,470]],"seekerSpawns":[[480,480]]}', 4)
